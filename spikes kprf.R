...
electoral <- read.csv("C:/Users/Cole/Documents/Research topics literature/All Russian election data/2016 Russia election data full.csv")
...
keepvars <- c("ballots.received", "kprf", "voter.list") 

fraud.estimates <- read.csv("~/Research projects/mexico_russia_fraud/fraud_estimates_russia_2016.csv")


#Set up a loop to calculate spikes for each region
i <- 1
for(i in 72:max(electoral2$temp.id)){
  ...
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/KPRF/2018/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
...
###2011
###Must re-run 2011 and 2008 to get the plots correct.
rm(list=ls())
library(tidyverse)
library(spikes)
...
electoral <- read.csv("C:/Users/Cole/Documents/Grad school/Research topics/All Russian election data/2008 presidential election condensed csv.csv")
key.table <- read.csv("C:/Users/Cole/Documents/Grad school/Dissertation/Region ID lists/russia region ids.csv")  #Loads the regionid values
key.table <- rename(key.table, english.name = ï..english.name)
...
keepvars <- c("ballots.received", "medvedev", "voter.list") 
...
for(i in 1:max(electoral2$regionid)){
  ...
  fraud.estimates[i,4] <- nrow(sub.reg)
  fraud.estimates[i,5] <- ((fraud.estimates[i,2] / 100) * nrow(sub.reg.spikes)) + fraud.estimates[i,3] 
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/2008/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
  png(filename = filename)
  plot.out(out)
  dev.off()
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/fraud_estimates_russia_2008.csv")
...
electoral <- read.csv("C:/Users/Cole/Documents/Grad school/Research topics/All Russian election data/2007 duma election condensed csv.csv")
key.table <- read.csv("C:/Users/Cole/Documents/Grad school/Dissertation/Region ID lists/russia region ids.csv")  #Loads the regionid values
key.table <- rename(key.table, english.name = ï..english.name)
...
keepvars <- c("ballots.received", "unitedrussia", "voterlist") 
...
for(i in 1:max(electoral2$regionid)){
  ...
  fraud.estimates[i,4] <- nrow(sub.reg)
  fraud.estimates[i,5] <- ((fraud.estimates[i,2] / 100) * nrow(sub.reg.spikes)) + fraud.estimates[i,3] 
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/2007/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
  png(filename = filename)
  plot.out(out)
  dev.off()
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/fraud_estimates_russia_2007.csv")
...
electoral <- read.csv("C:/Users/Cole/Documents/Grad school/Research topics/All Russian election data/2004 presidential election condensed csv.csv")
key.table <- read.csv("C:/Users/Cole/Documents/Grad school/Dissertation/Region ID lists/russia region ids.csv")  #Loads the regionid values
key.table <- rename(key.table, english.name = ï..english.name)
...
keepvars <- c("ballots.received", "Putin", "list") 
...
for(i in 1:max(electoral2$regionid)){
  ...
  fraud.estimates[i,4] <- nrow(sub.reg)
  fraud.estimates[i,5] <- ((fraud.estimates[i,2] / 100) * nrow(sub.reg.spikes)) + fraud.estimates[i,3] 
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/2004/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
  png(filename = filename)
  plot.out(out)
  dev.off()
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/fraud_estimates_russia_2004.csv")
...
electoral <- read.csv("C:/Users/Cole/Documents/Grad school/Research topics/All Russian election data/2003 duma election condensed big csv.csv")
key.table <- read.csv("C:/Users/Cole/Documents/Grad school/Dissertation/Region ID lists/russia region ids.csv")  #Loads the regionid values
key.table <- rename(key.table, english.name = ï..english.name)
...
for(i in 1:max(electoral2$regionid)){
  ...
  fraud.estimates[i,4] <- nrow(sub.reg)
  fraud.estimates[i,5] <- ((fraud.estimates[i,2] / 100) * nrow(sub.reg.spikes)) + fraud.estimates[i,3] 
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/2003/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
  png(filename = filename)
  plot.out(out)
  dev.off()
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/fraud_estimates_russia_2003.csv")
