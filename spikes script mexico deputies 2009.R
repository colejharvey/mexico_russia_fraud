...
electoral <- read.csv("C:/Users/Cole/Documents/Grad school/Dissertation/Mexico elections data/mexico 2009 deputies csv.csv")
...
for(i in 1:max(electoral2$id_estado)){
  ...
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/Mexico2009deps/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/Mexico/fraud_estimates_mexico_2009_deps_pri.csv")
...
for(i in 1:max(electoral2$id_estado)){
  ...
  fraud.estimates[i,4] <- nrow(sub.reg)
  fraud.estimates[i,5] <- ((fraud.estimates[i,2] / 100) * nrow(sub.reg.spikes)) + fraud.estimates[i,3] 
  filename <- paste("C:/Users/Cole/Documents/Research projects/mexico_russia_fraud/spike_plots/Mexico2009deps/PAN/", as.character(fraud.estimates[i,1]),
                    ".png", sep="")
  png(filename = filename)
  plot.out(out)
  dev.off()
...
write.csv(fraud.estimates, "~/Research projects/mexico_russia_fraud/Mexico/fraud_estimates_mexico_2009_deps_pan.csv")
